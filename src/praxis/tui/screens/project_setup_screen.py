    ...
    def on_mount(self) -> None:
        ...
        self.setup_text = "\n".join(
            [
                ...
                "  uv run --project /root/praxis-realworld-eval/repo praxis init --name 'My Project' --methodology agile",
                "",
                "Configure OpenRouter:",
                "  export OPENROUTER_API_KEY=...",
                "  uv run --project /root/praxis-realworld-eval/repo praxis profile create realworld --provider openrouter --model anthropic/claude-sonnet-4 --api-key-env OPENROUTER_API_KEY --set-default",
                "",
                "Launch this TUI:",
                "  PRAXIS_HOME=/root/praxis-realworld-eval/praxis-home uv run --project /root/praxis-realworld-eval/repo praxis tui --engagement <path>",
                "",
                "v0.2.0 avoids typing raw keys into the TUI. Put keys in the shell/service environment and store only env var names in Praxis profiles.",
            ]
        )
